...
class DowryFeatures(BaseModel):
    year: int
    womens_age: float = Field(..., alias="women's age")
    mens_age: float = Field(..., alias="men's age")
    mohor_log: float
    family_type_Lower_Class: int
    family_type_Poverty_Level: int
    family_type_Rich_Class: int
    area_Barguna: int
    area_Barishal: int
    area_Bhola: int
    area_Brahmanbaria: int
    area_Chandpur: int
    area_Chattogram: int
    area_Coxs_Bazar: int
    area_Cumilla: int
    ...
    area_Jhenaidah: int
    area_Joypurhat: int
    area_Khagrachhari: int
    area_Khulna: int
    area_Kishoreganj: int
    area_Kurigram: int
    area_Kushtia: int
    area_Lakshmipur: int
    area_Madaripur: int
    ...
    area_bagerhat: int
    area_bogura: int
    area_chapainawabganj: int
    area_chuadanga: int
    area_dinajpur: int
    area_gaibandha: int
    area_habiganj: int
    area_lalmonirhat: int
    area_mymensingh: int
    area_naogaon: int
    area_natore: int
    area_pabna: int
    ...
    area_sunamganj: int
    area_sylhet: int
    girls_job_Day_Labour: int
    girls_job_Service_Holder: int
    girls_job_Worker: int
    boys_job_Day_Labour: int
    boys_job_Driver: int
    boys_job_Farmer: int
    boys_job_Service_Holder: int
    boys_job_Worker: int
    marry_condition_Forced_Marriage: int
    marry_condition_Irrelevant_Marriage: int
    marry_condition_Love_Marriage: int
    women_married_unmarried_Single: int
    women_married_unmarried_Widow: int
